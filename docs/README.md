...
or deletes a posting; a correction is a *reversing* entry. This is enforced by the **database**,
...
one **Fastify** API whose **Zod** schemas are the single source of validation, types, *and* the
