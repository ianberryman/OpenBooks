...
/**
 * The harness this screen's tests share — `api-keys/test-support.tsx`, copied rather than
 * imported for the self-containment reason `queries.ts`'s own module header gives: no
 * screen folder imports another's, so each carries its own small copy of the harness that
 * reaches it.
 *
 * See `recurring-invoices/test-support.tsx` for why the API is stubbed at `fetch` and
