 ...
 * for the self-containment reason `queries.ts` gives: no screen folder imports another's.
 * See that module for why the API is stubbed at `fetch` and nowhere higher, and why the
 * globals are replaced at import time rather than in a `beforeEach`.
 */
