 ...
 */
export const reconciliationBalancesSchema = z.strictObject({
...
export const reconciliationSessionEventSchema = z.strictObject({
  id: z.uuid(),
  sessionId: z.uuid(),
 ...
 */
export const reconciliationSessionSchema = z.strictObject({
  id: z.uuid(),
 ...
 * is not.
 */
export const reopenReconciliationSessionRequestSchema = z.strictObject({
  reason: z
    .string()
    .trim()
    .min(1)
 ...
 */
export const reconciliationSessionSummarySchema = reconciliationSessionSchema.omit({
  events: true,
});
...
export const reconciliationSessionPageSchema = unpublishedPageSchema(
