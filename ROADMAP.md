...
| --------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **T1 — table stakes**       | Live bank feeds + credit-card/liability reconciliation  | **feed BUILT (OB-227, asset accounts); liability recon → OB-227b** | QBO/Xero/QBD all live                                        | **OB-227 (below) — BUILT** — `BankFeedProvider` seam, **Stripe Financial Connections**, **v1 = bring-your-own key only** (managed deferred); credit-card/liability recon generalisation is the deferred OB-227b |
...
PB's and Q's, not run by the gate. **The credit-card/liability follow-on (OB-227b) — the
normal-balance-aware reconciliation change, not new feed plumbing — remains the one deferred piece.**
